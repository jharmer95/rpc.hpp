...
TEST_CASE("RunServer")
{
    ...
    char command[] = "..\\tests\\test_server.exe";
    ...
    const auto path = std::filesystem::read_symlink("/proc/self/exe").parent_path().parent_path().parent_path().append("tests/bin").append(exe_name);
